...
describe('mostBlogs', () => {
    ...
    test(('of 1 blog return its author and 1 blog'), () => {
        ...
        expect(mostBlogs.author).toEqual(only1Blogs[0].author)
    ...
    test('of 3 blogs return the author with most blogs', () => {
        ...
        expect(mostBlogs.author).toEqual('Edsger W. Dijkstra')
    ...
    test('of all blogs return the author with most blogs', () => {
        ...
        expect(mostBlogs.author).toEqual('Robert C. Martin')
...
describe('mostLikes', () => {
    ...
    test('of empty array returns undefined', () => {
        ...
        const mostLikes = listhelper.mostLikes(emptyBlogs)
        expect(mostLikes).toEqual(undefined)
    })

    test(('of 1 blog return its author and its likes'), () => {
        const only1Blogs = [blogs[0]]

        const mostLikes = listhelper.mostLikes(only1Blogs)
        expect(mostLikes.author).toEqual(only1Blogs[0].author)
        expect(mostLikes.likes).toBe(7)
    })
    
    test('of 3 blogs return the author with most likes', () => {
        const only3Blogs = blogs.slice(0, 3)

        const mostLikes = listhelper.mostLikes(only3Blogs)
        expect(mostLikes.author).toEqual('Edsger W. Dijkstra')
        expect(mostLikes.likes).toBe(17)
    })

    test('of all blogs return the author with most likes', () => {
